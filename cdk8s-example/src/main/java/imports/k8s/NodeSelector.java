...
public interface NodeSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<NodeSelector> {
        private java.util.List<imports.k8s.NodeSelectorTerm> nodeSelectorTerms;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NodeSelector {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.NodeSelectorTerm> nodeSelectorTerms) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.nodeSelectorTerms = (java.util.List<imports.k8s.NodeSelectorTerm>)java.util.Objects.requireNonNull(nodeSelectorTerms, "nodeSelectorTerms is required");
        }
