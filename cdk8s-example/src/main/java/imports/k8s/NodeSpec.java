 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.554Z")
...
public interface NodeSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NodeSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.NodeConfigSource configSource, final java.lang.String externalId, final java.lang.String podCidr, final java.util.List<java.lang.String> podCidRs, final java.lang.String providerId, final java.util.List<? extends imports.k8s.Taint> taints, final java.lang.Boolean unschedulable) {
