 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.420Z")
...
public interface EnvVarSource extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<EnvVarSource> {
        private imports.k8s.ConfigMapKeySelector configMapKeyRef;
        private imports.k8s.ObjectFieldSelector fieldRef;
        private imports.k8s.ResourceFieldSelector resourceFieldRef;
        private imports.k8s.SecretKeySelector secretKeyRef;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EnvVarSource {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.ConfigMapKeySelector configMapKeyRef, final imports.k8s.ObjectFieldSelector fieldRef, final imports.k8s.ResourceFieldSelector resourceFieldRef, final imports.k8s.SecretKeySelector secretKeyRef) {
