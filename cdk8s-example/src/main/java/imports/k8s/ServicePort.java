...
public interface ServicePort extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ServicePort> {
        ...
        private imports.k8s.IntOrString targetPort;
        ...
        public ServicePort build() {
            return new Jsii$Proxy(port, appProtocol, name, nodePort, protocol, targetPort);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServicePort {
         ...
         */
        protected Jsii$Proxy(final java.lang.Number port, final java.lang.String appProtocol, final java.lang.String name, final java.lang.Number nodePort, final java.lang.String protocol, final imports.k8s.IntOrString targetPort) {
