 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.413Z")
...
public interface DownwardApiVolumeFile extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DownwardApiVolumeFile {
         ...
         */
        protected Jsii$Proxy(final java.lang.String path, final imports.k8s.ObjectFieldSelector fieldRef, final java.lang.Number mode, final imports.k8s.ResourceFieldSelector resourceFieldRef) {
