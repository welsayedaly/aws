 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.545Z")
...
public interface Lifecycle extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.Handler getPostStart() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.Handler getPreStop() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Lifecycle> {
        private imports.k8s.Handler postStart;
        private imports.k8s.Handler preStop;
         ...
         * @return {@code this}
         */
        public Builder postStart(imports.k8s.Handler postStart) {
         ...
         * @return {@code this}
         */
        public Builder preStop(imports.k8s.Handler preStop) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Lifecycle {
        private final imports.k8s.Handler postStart;
        private final imports.k8s.Handler preStop;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.postStart = software.amazon.jsii.Kernel.get(this, "postStart", software.amazon.jsii.NativeType.forClass(imports.k8s.Handler.class));
            this.preStop = software.amazon.jsii.Kernel.get(this, "preStop", software.amazon.jsii.NativeType.forClass(imports.k8s.Handler.class));
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        protected Jsii$Proxy(final imports.k8s.Handler postStart, final imports.k8s.Handler preStop) {
        ...
        @Override
        public final imports.k8s.Handler getPostStart() {
            return this.postStart;
        }

        @Override
        public final imports.k8s.Handler getPreStop() {
            return this.preStop;
        }
