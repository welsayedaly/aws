...
public interface KubeEndpointSliceProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubeEndpointSliceProps> {
        ...
        private java.util.List<imports.k8s.Endpoint> endpoints;
        private imports.k8s.ObjectMeta metadata;
        private java.util.List<imports.k8s.EndpointPort> ports;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeEndpointSliceProps {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String addressType, final java.util.List<? extends imports.k8s.Endpoint> endpoints, final imports.k8s.ObjectMeta metadata, final java.util.List<? extends imports.k8s.EndpointPort> ports) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.addressType = java.util.Objects.requireNonNull(addressType, "addressType is required");
            this.endpoints = (java.util.List<imports.k8s.Endpoint>)java.util.Objects.requireNonNull(endpoints, "endpoints is required");
            this.metadata = metadata;
            this.ports = (java.util.List<imports.k8s.EndpointPort>)ports;
        }
