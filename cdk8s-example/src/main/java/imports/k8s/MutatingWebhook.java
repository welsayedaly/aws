 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.551Z")
...
public interface MutatingWebhook extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<MutatingWebhook> {
        ...
        public MutatingWebhook build() {
            return new Jsii$Proxy(admissionReviewVersions, clientConfig, name, sideEffects, failurePolicy, matchPolicy, namespaceSelector, objectSelector, reinvocationPolicy, rules, timeoutSeconds);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MutatingWebhook {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> admissionReviewVersions, final imports.k8s.WebhookClientConfig clientConfig, final java.lang.String name, final java.lang.String sideEffects, final java.lang.String failurePolicy, final java.lang.String matchPolicy, final imports.k8s.LabelSelector namespaceSelector, final imports.k8s.LabelSelector objectSelector, final java.lang.String reinvocationPolicy, final java.util.List<? extends imports.k8s.RuleWithOperations> rules, final java.lang.Number timeoutSeconds) {
