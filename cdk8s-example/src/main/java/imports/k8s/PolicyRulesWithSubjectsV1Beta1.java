 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.580Z")
...
public interface PolicyRulesWithSubjectsV1Beta1 extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PolicyRulesWithSubjectsV1Beta1> {
        private java.util.List<imports.k8s.SubjectV1Beta1> subjects;
        private java.util.List<imports.k8s.NonResourcePolicyRuleV1Beta1> nonResourceRules;
        private java.util.List<imports.k8s.ResourcePolicyRuleV1Beta1> resourceRules;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PolicyRulesWithSubjectsV1Beta1 {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.SubjectV1Beta1> subjects, final java.util.List<? extends imports.k8s.NonResourcePolicyRuleV1Beta1> nonResourceRules, final java.util.List<? extends imports.k8s.ResourcePolicyRuleV1Beta1> resourceRules) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.subjects = (java.util.List<imports.k8s.SubjectV1Beta1>)java.util.Objects.requireNonNull(subjects, "subjects is required");
            this.nonResourceRules = (java.util.List<imports.k8s.NonResourcePolicyRuleV1Beta1>)nonResourceRules;
            this.resourceRules = (java.util.List<imports.k8s.ResourcePolicyRuleV1Beta1>)resourceRules;
        }
