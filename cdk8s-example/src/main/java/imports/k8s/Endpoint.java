 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.416Z")
...
public interface Endpoint extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Endpoint> {
        ...
        private imports.k8s.EndpointConditions conditions;
        private java.util.Map<java.lang.String, java.lang.String> deprecatedTopology;
        private imports.k8s.EndpointHints hints;
        ...
        public Endpoint build() {
            return new Jsii$Proxy(addresses, conditions, deprecatedTopology, hints, hostname, nodeName, targetRef, zone);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Endpoint {
         ...
         */
        protected Jsii$Proxy(final java.util.List<java.lang.String> addresses, final imports.k8s.EndpointConditions conditions, final java.util.Map<java.lang.String, java.lang.String> deprecatedTopology, final imports.k8s.EndpointHints hints, final java.lang.String hostname, final java.lang.String nodeName, final imports.k8s.ObjectReference targetRef, final java.lang.String zone) {
