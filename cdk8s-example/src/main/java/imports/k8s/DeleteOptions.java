 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.412Z")
...
public interface DeleteOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DeleteOptions> {
        ...
        private imports.k8s.IoK8SApimachineryPkgApisMetaV1DeleteOptionsKind kind;
        private java.lang.Boolean orphanDependents;
        private imports.k8s.Preconditions preconditions;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeleteOptions {
         ...
         */
        protected Jsii$Proxy(final java.lang.String apiVersion, final java.util.List<java.lang.String> dryRun, final java.lang.Number gracePeriodSeconds, final imports.k8s.IoK8SApimachineryPkgApisMetaV1DeleteOptionsKind kind, final java.lang.Boolean orphanDependents, final imports.k8s.Preconditions preconditions, final java.lang.String propagationPolicy) {
