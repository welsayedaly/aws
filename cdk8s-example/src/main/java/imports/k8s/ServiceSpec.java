 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.589Z")
...
public interface ServiceSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ServiceSpec> {
        ...
        private java.util.List<imports.k8s.ServicePort> ports;
        ...
        private imports.k8s.SessionAffinityConfig sessionAffinityConfig;
         ...
         * @param internalTrafficPolicy InternalTrafficPolicy specifies if the cluster internal traffic should be routed to all endpoints or node-local endpoints only.
         *                              "Cluster" routes internal traffic to a Service to all endpoints. "Local" routes traffic to node-local endpoints only, traffic is dropped if no node-local endpoints are ready. The default value is "Cluster".
         * @return {@code this}
         */
         ...
         * @param ipFamilies IPFamilies is a list of IP families (e.g. IPv4, IPv6) assigned to this service, and is gated by the "IPv6DualStack" feature gate.  This field is usually assigned automatically based on cluster configuration and the ipFamilyPolicy field. If this field is specified manually, the requested family is available in the cluster, and ipFamilyPolicy allows it, it will be used; otherwise creation of the service will fail.  This field is conditionally mutable: it allows for adding or removing a secondary IP family, but it does not allow changing the primary IP family of the Service.  Valid values are "IPv4" and "IPv6".  This field only applies to Services of types ClusterIP, NodePort, and LoadBalancer, and does apply to "headless" services.  This field will be wiped when updating a Service to type ExternalName.
         *                   This field may hold a maximum of two entries (dual-stack families, in either order).  These families must correspond to the values of the clusterIPs field, if specified. Both clusterIPs and ipFamilies are governed by the ipFamilyPolicy field.
         * @return {@code this}
         */
         ...
         * @param ipFamilyPolicy IPFamilyPolicy represents the dual-stack-ness requested or required by this Service, and is gated by the "IPv6DualStack" feature gate.
         *                       If there is no value provided, then this field will be set to SingleStack. Services can be "SingleStack" (a single IP family), "PreferDualStack" (two IP families on dual-stack configured clusters or a single IP family on single-stack clusters), or "RequireDualStack" (two IP families on dual-stack configured clusters, otherwise fail). The ipFamilies and clusterIPs fields depend on the value of this field.  This field will be wiped when updating a service to type ExternalName.
         * @return {@code this}
         */
        ...
        public ServiceSpec build() {
            return new Jsii$Proxy(allocateLoadBalancerNodePorts, clusterIp, clusterIPs, externalIPs, externalName, externalTrafficPolicy, healthCheckNodePort, internalTrafficPolicy, ipFamilies, ipFamilyPolicy, loadBalancerClass, loadBalancerIp, loadBalancerSourceRanges, ports, publishNotReadyAddresses, selector, sessionAffinity, sessionAffinityConfig, type);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.Boolean allocateLoadBalancerNodePorts, final java.lang.String clusterIp, final java.util.List<java.lang.String> clusterIPs, final java.util.List<java.lang.String> externalIPs, final java.lang.String externalName, final java.lang.String externalTrafficPolicy, final java.lang.Number healthCheckNodePort, final java.lang.String internalTrafficPolicy, final java.util.List<java.lang.String> ipFamilies, final java.lang.String ipFamilyPolicy, final java.lang.String loadBalancerClass, final java.lang.String loadBalancerIp, final java.util.List<java.lang.String> loadBalancerSourceRanges, final java.util.List<? extends imports.k8s.ServicePort> ports, final java.lang.Boolean publishNotReadyAddresses, final java.util.Map<java.lang.String, java.lang.String> selector, final java.lang.String sessionAffinity, final imports.k8s.SessionAffinityConfig sessionAffinityConfig, final java.lang.String type) {
