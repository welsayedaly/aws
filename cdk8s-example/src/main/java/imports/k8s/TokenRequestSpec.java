 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.599Z")
...
public interface TokenRequestSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<TokenRequestSpec> {
        ...
        private imports.k8s.BoundObjectReference boundObjectRef;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements TokenRequestSpec {
         ...
         */
        protected Jsii$Proxy(final java.util.List<java.lang.String> audiences, final imports.k8s.BoundObjectReference boundObjectRef, final java.lang.Number expirationSeconds) {
