...
public interface Probe extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Probe> {
        ...
        @Override
        public Probe build() {
            return new Jsii$Proxy(exec, failureThreshold, httpGet, initialDelaySeconds, periodSeconds, successThreshold, tcpSocket, terminationGracePeriodSeconds, timeoutSeconds);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Probe {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.ExecAction exec, final java.lang.Number failureThreshold, final imports.k8s.HttpGetAction httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final imports.k8s.TcpSocketAction tcpSocket, final java.lang.Number terminationGracePeriodSeconds, final java.lang.Number timeoutSeconds) {
