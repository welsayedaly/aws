...
public interface HpaScalingRulesV2Beta2 extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<HpaScalingRulesV2Beta2> {
        private java.util.List<imports.k8s.HpaScalingPolicyV2Beta2> policies;
        private java.lang.String selectPolicy;
        private java.lang.Number stabilizationWindowSeconds;
        ...
        public HpaScalingRulesV2Beta2 build() {
            return new Jsii$Proxy(policies, selectPolicy, stabilizationWindowSeconds);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HpaScalingRulesV2Beta2 {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.HpaScalingPolicyV2Beta2> policies, final java.lang.String selectPolicy, final java.lang.Number stabilizationWindowSeconds) {
