...
public interface PodDnsConfig extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodDnsConfig {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> nameservers, final java.util.List<? extends imports.k8s.PodDnsConfigOption> options, final java.util.List<java.lang.String> searches) {
