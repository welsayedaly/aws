 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.434Z")
...
public interface HttpGetAction extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<HttpGetAction> {
        ...
        private java.util.List<imports.k8s.HttpHeader> httpHeaders;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HttpGetAction {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.IntOrString port, final java.lang.String host, final java.util.List<? extends imports.k8s.HttpHeader> httpHeaders, final java.lang.String path, final java.lang.String scheme) {
