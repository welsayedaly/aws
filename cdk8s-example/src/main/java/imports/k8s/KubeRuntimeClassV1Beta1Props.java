 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.530Z")
...
public interface KubeRuntimeClassV1Beta1Props extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.OverheadV1Beta1 getOverhead() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.SchedulingV1Beta1 getScheduling() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubeRuntimeClassV1Beta1Props> {
        ...
        private imports.k8s.OverheadV1Beta1 overhead;
        private imports.k8s.SchedulingV1Beta1 scheduling;
        ...
        /**
         * Sets the value of {@link KubeRuntimeClassV1Beta1Props#getOverhead}
         * @param overhead Overhead represents the resource overhead associated with running a pod for a given RuntimeClass.
         *                 For more details, see https://git.k8s.io/enhancements/keps/sig-node/688-pod-overhead/README.md This field is beta-level as of Kubernetes v1.18, and is only honored by servers that enable the PodOverhead feature.
         * @return {@code this}
         */
        public Builder overhead(imports.k8s.OverheadV1Beta1 overhead) {
            this.overhead = overhead;
            return this;
        }

        /**
         * Sets the value of {@link KubeRuntimeClassV1Beta1Props#getScheduling}
         ...
         * @return {@code this}
         */
        public Builder scheduling(imports.k8s.SchedulingV1Beta1 scheduling) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeRuntimeClassV1Beta1Props {
        ...
        private final imports.k8s.OverheadV1Beta1 overhead;
        private final imports.k8s.SchedulingV1Beta1 scheduling;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.overhead = software.amazon.jsii.Kernel.get(this, "overhead", software.amazon.jsii.NativeType.forClass(imports.k8s.OverheadV1Beta1.class));
            this.scheduling = software.amazon.jsii.Kernel.get(this, "scheduling", software.amazon.jsii.NativeType.forClass(imports.k8s.SchedulingV1Beta1.class));
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        protected Jsii$Proxy(final java.lang.String handler, final imports.k8s.ObjectMeta metadata, final imports.k8s.OverheadV1Beta1 overhead, final imports.k8s.SchedulingV1Beta1 scheduling) {
        ...
        @Override
        public final imports.k8s.OverheadV1Beta1 getOverhead() {
            return this.overhead;
        }

        @Override
        public final imports.k8s.SchedulingV1Beta1 getScheduling() {
