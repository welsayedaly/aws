 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.437Z")
...
public interface IngressSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<IngressSpec> {
        private imports.k8s.IngressBackend defaultBackend;
        ...
        public IngressSpec build() {
            return new Jsii$Proxy(defaultBackend, ingressClassName, rules, tls);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements IngressSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.IngressBackend defaultBackend, final java.lang.String ingressClassName, final java.util.List<? extends imports.k8s.IngressRule> rules, final java.util.List<? extends imports.k8s.IngressTls> tls) {
