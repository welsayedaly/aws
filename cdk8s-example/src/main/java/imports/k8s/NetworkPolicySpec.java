 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.553Z")
...
public interface NetworkPolicySpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<NetworkPolicySpec> {
        private imports.k8s.LabelSelector podSelector;
        private java.util.List<imports.k8s.NetworkPolicyEgressRule> egress;
        private java.util.List<imports.k8s.NetworkPolicyIngressRule> ingress;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicySpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.LabelSelector podSelector, final java.util.List<? extends imports.k8s.NetworkPolicyEgressRule> egress, final java.util.List<? extends imports.k8s.NetworkPolicyIngressRule> ingress, final java.util.List<java.lang.String> policyTypes) {
