 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.399Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.CronJobSpecV1Beta1")
...
public interface CronJobSpecV1Beta1 extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.k8s.JobTemplateSpecV1Beta1 getJobTemplate();
     ...
     */
    public static final class Builder implements software.amazon.jsii.Builder<CronJobSpecV1Beta1> {
        private imports.k8s.JobTemplateSpecV1Beta1 jobTemplate;
         ...
         * @return {@code this}
         */
        public Builder jobTemplate(imports.k8s.JobTemplateSpecV1Beta1 jobTemplate) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CronJobSpecV1Beta1 {
        private final imports.k8s.JobTemplateSpecV1Beta1 jobTemplate;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.jobTemplate = software.amazon.jsii.Kernel.get(this, "jobTemplate", software.amazon.jsii.NativeType.forClass(imports.k8s.JobTemplateSpecV1Beta1.class));
         ...
         */
        protected Jsii$Proxy(final imports.k8s.JobTemplateSpecV1Beta1 jobTemplate, final java.lang.String schedule, final java.lang.String concurrencyPolicy, final java.lang.Number failedJobsHistoryLimit, final java.lang.Number startingDeadlineSeconds, final java.lang.Number successfulJobsHistoryLimit, final java.lang.Boolean suspend) {
        ...
        @Override
        public final imports.k8s.JobTemplateSpecV1Beta1 getJobTemplate() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("k8s.CronJobSpecV1Beta1"));
