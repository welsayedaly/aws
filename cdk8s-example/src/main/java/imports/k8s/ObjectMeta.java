 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.555Z")
...
public interface ObjectMeta extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ObjectMeta> {
        ...
        private java.util.List<imports.k8s.ManagedFieldsEntry> managedFields;
        private java.lang.String name;
        private java.lang.String namespace;
        private java.util.List<imports.k8s.OwnerReference> ownerReferences;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ObjectMeta {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.Map<java.lang.String, java.lang.String> annotations, final java.lang.String clusterName, final java.time.Instant creationTimestamp, final java.lang.Number deletionGracePeriodSeconds, final java.time.Instant deletionTimestamp, final java.util.List<java.lang.String> finalizers, final java.lang.String generateName, final java.lang.Number generation, final java.util.Map<java.lang.String, java.lang.String> labels, final java.util.List<? extends imports.k8s.ManagedFieldsEntry> managedFields, final java.lang.String name, final java.lang.String namespace, final java.util.List<? extends imports.k8s.OwnerReference> ownerReferences, final java.lang.String resourceVersion, final java.lang.String selfLink, final java.lang.String uid) {
