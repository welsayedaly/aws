...
public interface SubjectAccessReviewSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<SubjectAccessReviewSpec> {
        ...
        private imports.k8s.NonResourceAttributes nonResourceAttributes;
        private imports.k8s.ResourceAttributes resourceAttributes;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SubjectAccessReviewSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.Map<java.lang.String, ? extends java.util.List<java.lang.String>> extra, final java.util.List<java.lang.String> groups, final imports.k8s.NonResourceAttributes nonResourceAttributes, final imports.k8s.ResourceAttributes resourceAttributes, final java.lang.String uid, final java.lang.String user) {
