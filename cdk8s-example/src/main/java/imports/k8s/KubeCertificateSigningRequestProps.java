 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.458Z")
...
public interface KubeCertificateSigningRequestProps extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeCertificateSigningRequestProps {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.CertificateSigningRequestSpec spec, final imports.k8s.ObjectMeta metadata) {
