 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.368Z")
...
public interface Affinity extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Affinity> {
        private imports.k8s.NodeAffinity nodeAffinity;
        private imports.k8s.PodAffinity podAffinity;
        private imports.k8s.PodAntiAffinity podAntiAffinity;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Affinity {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.NodeAffinity nodeAffinity, final imports.k8s.PodAffinity podAffinity, final imports.k8s.PodAntiAffinity podAntiAffinity) {
