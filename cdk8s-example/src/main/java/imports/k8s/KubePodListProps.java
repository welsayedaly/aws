 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.512Z")
...
public interface KubePodListProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubePodListProps> {
        private java.util.List<imports.k8s.KubePodProps> items;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubePodListProps {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.KubePodProps> items, final imports.k8s.ListMeta metadata) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.items = (java.util.List<imports.k8s.KubePodProps>)java.util.Objects.requireNonNull(items, "items is required");
            this.metadata = metadata;
        }
