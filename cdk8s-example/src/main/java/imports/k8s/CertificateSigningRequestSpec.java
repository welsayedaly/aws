 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.383Z")
...
public interface CertificateSigningRequestSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CertificateSigningRequestSpec> {
        ...
        public CertificateSigningRequestSpec build() {
            return new Jsii$Proxy(request, signerName, expirationSeconds, extra, groups, uid, usages, username);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CertificateSigningRequestSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String request, final java.lang.String signerName, final java.lang.Number expirationSeconds, final java.util.Map<java.lang.String, ? extends java.util.List<java.lang.String>> extra, final java.util.List<java.lang.String> groups, final java.lang.String uid, final java.util.List<java.lang.String> usages, final java.lang.String username) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.request = java.util.Objects.requireNonNull(request, "request is required");
            this.signerName = java.util.Objects.requireNonNull(signerName, "signerName is required");
            this.expirationSeconds = expirationSeconds;
            this.extra = (java.util.Map<java.lang.String, java.util.List<java.lang.String>>)extra;
            this.groups = groups;
            this.uid = uid;
