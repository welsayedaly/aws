...
public interface ManagedFieldsEntry extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ManagedFieldsEntry> {
        ...
        public ManagedFieldsEntry build() {
            return new Jsii$Proxy(apiVersion, fieldsType, fieldsV1, manager, operation, subresource, time);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ManagedFieldsEntry {
         ...
         */
        protected Jsii$Proxy(final java.lang.String apiVersion, final java.lang.String fieldsType, final java.lang.Object fieldsV1, final java.lang.String manager, final java.lang.String operation, final java.lang.String subresource, final java.time.Instant time) {
