 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.493Z")
...
public interface KubeEventV1Beta1Props extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.EventSeriesV1Beta1 getSeries() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubeEventV1Beta1Props> {
        ...
        private imports.k8s.EventSeriesV1Beta1 series;
         ...
         * @return {@code this}
         */
        public Builder series(imports.k8s.EventSeriesV1Beta1 series) {
            this.series = series;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeEventV1Beta1Props {
        ...
        private final imports.k8s.EventSeriesV1Beta1 series;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.series = software.amazon.jsii.Kernel.get(this, "series", software.amazon.jsii.NativeType.forClass(imports.k8s.EventSeriesV1Beta1.class));
         ...
         */
        protected Jsii$Proxy(final java.time.Instant eventTime, final java.lang.String action, final java.lang.Number deprecatedCount, final java.time.Instant deprecatedFirstTimestamp, final java.time.Instant deprecatedLastTimestamp, final imports.k8s.EventSource deprecatedSource, final imports.k8s.ObjectMeta metadata, final java.lang.String note, final java.lang.String reason, final imports.k8s.ObjectReference regarding, final imports.k8s.ObjectReference related, final java.lang.String reportingController, final java.lang.String reportingInstance, final imports.k8s.EventSeriesV1Beta1 series, final java.lang.String type) {
        ...
        @Override
        public final imports.k8s.EventSeriesV1Beta1 getSeries() {
            return this.series;
        }
