...
public interface NodeSelectorTerm extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<NodeSelectorTerm> {
        private java.util.List<imports.k8s.NodeSelectorRequirement> matchExpressions;
        private java.util.List<imports.k8s.NodeSelectorRequirement> matchFields;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NodeSelectorTerm {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.NodeSelectorRequirement> matchExpressions, final java.util.List<? extends imports.k8s.NodeSelectorRequirement> matchFields) {
