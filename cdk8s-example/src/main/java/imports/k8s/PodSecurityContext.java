 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.564Z")
...
public interface PodSecurityContext extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSecurityContext> {
        ...
        public PodSecurityContext build() {
            return new Jsii$Proxy(fsGroup, fsGroupChangePolicy, runAsGroup, runAsNonRoot, runAsUser, seccompProfile, seLinuxOptions, supplementalGroups, sysctls, windowsOptions);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityContext {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.Number fsGroup, final java.lang.String fsGroupChangePolicy, final java.lang.Number runAsGroup, final java.lang.Boolean runAsNonRoot, final java.lang.Number runAsUser, final imports.k8s.SeccompProfile seccompProfile, final imports.k8s.SeLinuxOptions seLinuxOptions, final java.util.List<? extends java.lang.Number> supplementalGroups, final java.util.List<? extends imports.k8s.Sysctl> sysctls, final imports.k8s.WindowsSecurityContextOptions windowsOptions) {
