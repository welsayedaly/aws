...
public interface SubjectV1Beta1 extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<SubjectV1Beta1> {
        ...
        private imports.k8s.GroupSubjectV1Beta1 group;
        private imports.k8s.ServiceAccountSubjectV1Beta1 serviceAccount;
        private imports.k8s.UserSubjectV1Beta1 user;
        ...
        public SubjectV1Beta1 build() {
            return new Jsii$Proxy(kind, group, serviceAccount, user);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SubjectV1Beta1 {
         ...
         */
        protected Jsii$Proxy(final java.lang.String kind, final imports.k8s.GroupSubjectV1Beta1 group, final imports.k8s.ServiceAccountSubjectV1Beta1 serviceAccount, final imports.k8s.UserSubjectV1Beta1 user) {
