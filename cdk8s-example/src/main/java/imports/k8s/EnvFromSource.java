 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.419Z")
...
public interface EnvFromSource extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<EnvFromSource> {
        private imports.k8s.ConfigMapEnvSource configMapRef;
        private java.lang.String prefix;
        private imports.k8s.SecretEnvSource secretRef;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EnvFromSource {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.ConfigMapEnvSource configMapRef, final java.lang.String prefix, final imports.k8s.SecretEnvSource secretRef) {
