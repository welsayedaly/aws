 ...
 * ]
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.488Z")
...
public interface KubeEndpointsProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubeEndpointsProps> {
        ...
        private java.util.List<imports.k8s.EndpointSubset> subsets;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeEndpointsProps {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.ObjectMeta metadata, final java.util.List<? extends imports.k8s.EndpointSubset> subsets) {
