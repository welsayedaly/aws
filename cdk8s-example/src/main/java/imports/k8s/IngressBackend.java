 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.435Z")
...
public interface IngressBackend extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<IngressBackend> {
        private imports.k8s.TypedLocalObjectReference resource;
        private imports.k8s.IngressServiceBackend service;
        ...
        public IngressBackend build() {
            return new Jsii$Proxy(resource, service);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements IngressBackend {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.TypedLocalObjectReference resource, final imports.k8s.IngressServiceBackend service) {
