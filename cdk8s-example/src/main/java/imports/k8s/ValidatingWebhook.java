...
public interface ValidatingWebhook extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingWebhook {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> admissionReviewVersions, final imports.k8s.WebhookClientConfig clientConfig, final java.lang.String name, final java.lang.String sideEffects, final java.lang.String failurePolicy, final java.lang.String matchPolicy, final imports.k8s.LabelSelector namespaceSelector, final imports.k8s.LabelSelector objectSelector, final java.util.List<? extends imports.k8s.RuleWithOperations> rules, final java.lang.Number timeoutSeconds) {
