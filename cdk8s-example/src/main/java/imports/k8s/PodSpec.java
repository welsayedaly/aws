 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.567Z")
...
public interface PodSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSpec> {
        ...
        private java.util.List<imports.k8s.EphemeralContainer> ephemeralContainers;
        ...
        private java.util.Map<java.lang.String, imports.k8s.Quantity> overhead;
        ...
        private java.util.List<imports.k8s.TopologySpreadConstraint> topologySpreadConstraints;
