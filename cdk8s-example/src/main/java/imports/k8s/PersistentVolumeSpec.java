 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.561Z")
...
public interface PersistentVolumeSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeSpec> {
        ...
        private imports.k8s.AzureFilePersistentVolumeSource azureFile;
        private java.util.Map<java.lang.String, imports.k8s.Quantity> capacity;
        private imports.k8s.CephFsPersistentVolumeSource cephfs;
        private imports.k8s.CinderPersistentVolumeSource cinder;
        private imports.k8s.ObjectReference claimRef;
        private imports.k8s.CsiPersistentVolumeSource csi;
        private imports.k8s.FcVolumeSource fc;
        private imports.k8s.FlexPersistentVolumeSource flexVolume;
        private imports.k8s.FlockerVolumeSource flocker;
        private imports.k8s.GcePersistentDiskVolumeSource gcePersistentDisk;
        private imports.k8s.GlusterfsPersistentVolumeSource glusterfs;
        private imports.k8s.HostPathVolumeSource hostPath;
        private imports.k8s.IscsiPersistentVolumeSource iscsi;
        private imports.k8s.LocalVolumeSource local;
        private java.util.List<java.lang.String> mountOptions;
        private imports.k8s.NfsVolumeSource nfs;
        private imports.k8s.VolumeNodeAffinity nodeAffinity;
        ...
        private imports.k8s.RbdPersistentVolumeSource rbd;
        private imports.k8s.ScaleIoPersistentVolumeSource scaleIo;
        private java.lang.String storageClassName;
        private imports.k8s.StorageOsPersistentVolumeSource storageos;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> accessModes, final imports.k8s.AwsElasticBlockStoreVolumeSource awsElasticBlockStore, final imports.k8s.AzureDiskVolumeSource azureDisk, final imports.k8s.AzureFilePersistentVolumeSource azureFile, final java.util.Map<java.lang.String, ? extends imports.k8s.Quantity> capacity, final imports.k8s.CephFsPersistentVolumeSource cephfs, final imports.k8s.CinderPersistentVolumeSource cinder, final imports.k8s.ObjectReference claimRef, final imports.k8s.CsiPersistentVolumeSource csi, final imports.k8s.FcVolumeSource fc, final imports.k8s.FlexPersistentVolumeSource flexVolume, final imports.k8s.FlockerVolumeSource flocker, final imports.k8s.GcePersistentDiskVolumeSource gcePersistentDisk, final imports.k8s.GlusterfsPersistentVolumeSource glusterfs, final imports.k8s.HostPathVolumeSource hostPath, final imports.k8s.IscsiPersistentVolumeSource iscsi, final imports.k8s.LocalVolumeSource local, final java.util.List<java.lang.String> mountOptions, final imports.k8s.NfsVolumeSource nfs, final imports.k8s.VolumeNodeAffinity nodeAffinity, final java.lang.String persistentVolumeReclaimPolicy, final imports.k8s.PhotonPersistentDiskVolumeSource photonPersistentDisk, final imports.k8s.PortworxVolumeSource portworxVolume, final imports.k8s.QuobyteVolumeSource quobyte, final imports.k8s.RbdPersistentVolumeSource rbd, final imports.k8s.ScaleIoPersistentVolumeSource scaleIo, final java.lang.String storageClassName, final imports.k8s.StorageOsPersistentVolumeSource storageos, final java.lang.String volumeMode, final imports.k8s.VsphereVirtualDiskVolumeSource vsphereVolume) {
