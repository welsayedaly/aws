 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.558Z")
...
public interface PersistentVolumeClaimSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeClaimSpec> {
        ...
        private imports.k8s.TypedLocalObjectReference dataSource;
        private imports.k8s.TypedLocalObjectReference dataSourceRef;
         ...
         * @param dataSourceRef Specifies the object from which to populate the volume with data, if a non-empty volume is desired.
         *                      This may be any local object from a non-empty API group (non core object) or a PersistentVolumeClaim object. When this field is specified, volume binding will only succeed if the type of the specified object matches some installed volume populator or dynamic provisioner. This field will replace the functionality of the DataSource field and as such if both fields are non-empty, they must have the same value. For backwards compatibility, both fields (DataSource and DataSourceRef) will be set to the same value automatically if one of them is empty and the other is non-empty. There are two important differences between DataSource and DataSourceRef: * While DataSource only allows two specific types of objects, DataSourceRef
         *                      allows any non-core object, as well as PersistentVolumeClaim objects.
         *                      <p>
         *                      <ul>
        ...
        public PersistentVolumeClaimSpec build() {
            return new Jsii$Proxy(accessModes, dataSource, dataSourceRef, resources, selector, storageClassName, volumeMode, volumeName);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeClaimSpec {
         ...
         */
        protected Jsii$Proxy(final java.util.List<java.lang.String> accessModes, final imports.k8s.TypedLocalObjectReference dataSource, final imports.k8s.TypedLocalObjectReference dataSourceRef, final imports.k8s.ResourceRequirements resources, final imports.k8s.LabelSelector selector, final java.lang.String storageClassName, final java.lang.String volumeMode, final java.lang.String volumeName) {
