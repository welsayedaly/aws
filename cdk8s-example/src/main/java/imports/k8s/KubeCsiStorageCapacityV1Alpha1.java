...
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.KubeCsiStorageCapacityV1Alpha1")
public class KubeCsiStorageCapacityV1Alpha1 extends org.cdk8s.ApiObject {

    protected KubeCsiStorageCapacityV1Alpha1(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected KubeCsiStorageCapacityV1Alpha1(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        GVK = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.k8s.KubeCsiStorageCapacityV1Alpha1.class, "GVK", software.amazon.jsii.NativeType.forClass(org.cdk8s.GroupVersionKind.class));
    }
     ...
     */
    public KubeCsiStorageCapacityV1Alpha1(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.k8s.KubeCsiStorageCapacityV1Alpha1Props props) {
     ...
     * @param props initialization props. This parameter is required.
     */
    public static @org.jetbrains.annotations.NotNull java.lang.Object manifest(final @org.jetbrains.annotations.NotNull imports.k8s.KubeCsiStorageCapacityV1Alpha1Props props) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(imports.k8s.KubeCsiStorageCapacityV1Alpha1.class, "manifest", software.amazon.jsii.NativeType.forClass(java.lang.Object.class), new Object[] { java.util.Objects.requireNonNull(props, "props is required") });
    }
    ...
    /**
     * A fluent builder for {@link imports.k8s.KubeCsiStorageCapacityV1Alpha1}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.KubeCsiStorageCapacityV1Alpha1> {
        /**
        ...
        private final imports.k8s.KubeCsiStorageCapacityV1Alpha1Props.Builder props;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.props = new imports.k8s.KubeCsiStorageCapacityV1Alpha1Props.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.k8s.KubeCsiStorageCapacityV1Alpha1}.
         */
        @Override
        public imports.k8s.KubeCsiStorageCapacityV1Alpha1 build() {
            return new imports.k8s.KubeCsiStorageCapacityV1Alpha1(
                this.scope,
                this.id,
                this.props.build()
            );
