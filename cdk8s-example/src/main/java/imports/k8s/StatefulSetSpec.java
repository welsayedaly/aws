 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.591Z")
...
public interface StatefulSetSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpec> {
        ...
        private imports.k8s.StatefulSetUpdateStrategy updateStrategy;
        private java.util.List<imports.k8s.KubePersistentVolumeClaimProps> volumeClaimTemplates;
        ...
        public StatefulSetSpec build() {
            return new Jsii$Proxy(selector, serviceName, template, minReadySeconds, podManagementPolicy, replicas, revisionHistoryLimit, updateStrategy, volumeClaimTemplates);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.LabelSelector selector, final java.lang.String serviceName, final imports.k8s.PodTemplateSpec template, final java.lang.Number minReadySeconds, final java.lang.String podManagementPolicy, final java.lang.Number replicas, final java.lang.Number revisionHistoryLimit, final imports.k8s.StatefulSetUpdateStrategy updateStrategy, final java.util.List<? extends imports.k8s.KubePersistentVolumeClaimProps> volumeClaimTemplates) {
