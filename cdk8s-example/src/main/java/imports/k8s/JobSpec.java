 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.448Z")
...
public interface JobSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpec> {
        ...
        public JobSpec build() {
            return new Jsii$Proxy(template, activeDeadlineSeconds, backoffLimit, completionMode, completions, manualSelector, parallelism, selector, suspend, ttlSecondsAfterFinished);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpec {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.PodTemplateSpec template, final java.lang.Number activeDeadlineSeconds, final java.lang.Number backoffLimit, final java.lang.String completionMode, final java.lang.Number completions, final java.lang.Boolean manualSelector, final java.lang.Number parallelism, final imports.k8s.LabelSelector selector, final java.lang.Boolean suspend, final java.lang.Number ttlSecondsAfterFinished) {
