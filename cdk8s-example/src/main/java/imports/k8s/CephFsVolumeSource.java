...
public interface CephFsVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CephFsVolumeSource {
         ...
         */
        protected Jsii$Proxy(final java.util.List<java.lang.String> monitors, final java.lang.String path, final java.lang.Boolean readOnly, final java.lang.String secretFile, final imports.k8s.LocalObjectReference secretRef, final java.lang.String user) {
