...
public interface KubeRuntimeClassV1Alpha1Props extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.k8s.RuntimeClassSpecV1Alpha1 getSpec();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubeRuntimeClassV1Alpha1Props> {
        private imports.k8s.RuntimeClassSpecV1Alpha1 spec;
         ...
         * @return {@code this}
         */
        public Builder spec(imports.k8s.RuntimeClassSpecV1Alpha1 spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeRuntimeClassV1Alpha1Props {
        private final imports.k8s.RuntimeClassSpecV1Alpha1 spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.k8s.RuntimeClassSpecV1Alpha1.class));
         ...
         */
        protected Jsii$Proxy(final imports.k8s.RuntimeClassSpecV1Alpha1 spec, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public final imports.k8s.RuntimeClassSpecV1Alpha1 getSpec() {
            return this.spec;
        }
