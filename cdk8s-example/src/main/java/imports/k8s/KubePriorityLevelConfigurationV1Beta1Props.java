 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.522Z")
...
public interface KubePriorityLevelConfigurationV1Beta1Props extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubePriorityLevelConfigurationV1Beta1Props> {
        ...
        private imports.k8s.PriorityLevelConfigurationSpecV1Beta1 spec;
         ...
         * @param spec `spec` is the specification of the desired behavior of a "request-priority".
         *             More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
         * @return {@code this}
         */
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubePriorityLevelConfigurationV1Beta1Props {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.ObjectMeta metadata, final imports.k8s.PriorityLevelConfigurationSpecV1Beta1 spec) {
