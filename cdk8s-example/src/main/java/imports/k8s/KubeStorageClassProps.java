 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.536Z")
...
public interface KubeStorageClassProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubeStorageClassProps> {
        ...
        private java.util.List<imports.k8s.TopologySelectorTerm> allowedTopologies;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeStorageClassProps {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String provisioner, final java.util.List<? extends imports.k8s.TopologySelectorTerm> allowedTopologies, final java.lang.Boolean allowVolumeExpansion, final imports.k8s.ObjectMeta metadata, final java.util.List<java.lang.String> mountOptions, final java.util.Map<java.lang.String, java.lang.String> parameters, final java.lang.String reclaimPolicy, final java.lang.String volumeBindingMode) {
