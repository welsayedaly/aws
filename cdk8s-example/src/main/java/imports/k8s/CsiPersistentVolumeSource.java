 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.406Z")
...
public interface CsiPersistentVolumeSource extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CsiPersistentVolumeSource> {
        ...
        private imports.k8s.SecretReference controllerExpandSecretRef;
        private imports.k8s.SecretReference controllerPublishSecretRef;
        private java.lang.String fsType;
        private imports.k8s.SecretReference nodePublishSecretRef;
        private imports.k8s.SecretReference nodeStageSecretRef;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CsiPersistentVolumeSource {
         ...
         */
        protected Jsii$Proxy(final java.lang.String driver, final java.lang.String volumeHandle, final imports.k8s.SecretReference controllerExpandSecretRef, final imports.k8s.SecretReference controllerPublishSecretRef, final java.lang.String fsType, final imports.k8s.SecretReference nodePublishSecretRef, final imports.k8s.SecretReference nodeStageSecretRef, final java.lang.Boolean readOnly, final java.util.Map<java.lang.String, java.lang.String> volumeAttributes) {
