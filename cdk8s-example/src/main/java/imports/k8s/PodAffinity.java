 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.562Z")
...
public interface PodAffinity extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodAffinity> {
        private java.util.List<imports.k8s.WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution;
        private java.util.List<imports.k8s.PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodAffinity {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution, final java.util.List<? extends imports.k8s.PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution) {
