 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.401Z")
...
public interface CsiDriverSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CsiDriverSpec> {
        ...
        private java.util.List<imports.k8s.TokenRequest> tokenRequests;
        ...
        public CsiDriverSpec build() {
            return new Jsii$Proxy(attachRequired, fsGroupPolicy, podInfoOnMount, requiresRepublish, storageCapacity, tokenRequests, volumeLifecycleModes);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CsiDriverSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.Boolean attachRequired, final java.lang.String fsGroupPolicy, final java.lang.Boolean podInfoOnMount, final java.lang.Boolean requiresRepublish, final java.lang.Boolean storageCapacity, final java.util.List<? extends imports.k8s.TokenRequest> tokenRequests, final java.util.List<java.lang.String> volumeLifecycleModes) {
