 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.588Z")
...
public interface SecurityContext extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<SecurityContext> {
        ...
        private imports.k8s.Capabilities capabilities;
        ...
        private imports.k8s.SeccompProfile seccompProfile;
        ...
        public SecurityContext build() {
            return new Jsii$Proxy(allowPrivilegeEscalation, capabilities, privileged, procMount, readOnlyRootFilesystem, runAsGroup, runAsNonRoot, runAsUser, seccompProfile, seLinuxOptions, windowsOptions);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecurityContext {
         ...
         */
        protected Jsii$Proxy(final java.lang.Boolean allowPrivilegeEscalation, final imports.k8s.Capabilities capabilities, final java.lang.Boolean privileged, final java.lang.String procMount, final java.lang.Boolean readOnlyRootFilesystem, final java.lang.Number runAsGroup, final java.lang.Boolean runAsNonRoot, final java.lang.Number runAsUser, final imports.k8s.SeccompProfile seccompProfile, final imports.k8s.SeLinuxOptions seLinuxOptions, final imports.k8s.WindowsSecurityContextOptions windowsOptions) {
