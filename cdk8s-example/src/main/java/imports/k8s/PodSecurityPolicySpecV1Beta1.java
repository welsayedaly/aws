 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.565Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.PodSecurityPolicySpecV1Beta1")
...
public interface PodSecurityPolicySpecV1Beta1 extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.k8s.FsGroupStrategyOptionsV1Beta1 getFsGroup();

    /**
     * runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
     */
    @org.jetbrains.annotations.NotNull imports.k8s.RunAsUserStrategyOptionsV1Beta1 getRunAsUser();

    /**
     * seLinux is the strategy that will dictate the allowable labels that may be set.
     */
    @org.jetbrains.annotations.NotNull imports.k8s.SeLinuxStrategyOptionsV1Beta1 getSeLinux();

    /**
     * supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
     */
    @org.jetbrains.annotations.NotNull imports.k8s.SupplementalGroupsStrategyOptionsV1Beta1 getSupplementalGroups();
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.AllowedCsiDriverV1Beta1> getAllowedCsiDrivers() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.AllowedFlexVolumeV1Beta1> getAllowedFlexVolumes() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.AllowedHostPathV1Beta1> getAllowedHostPaths() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.HostPortRangeV1Beta1> getHostPorts() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.RunAsGroupStrategyOptionsV1Beta1 getRunAsGroup() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.RuntimeClassStrategyOptionsV1Beta1 getRuntimeClass() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSecurityPolicySpecV1Beta1> {
        private imports.k8s.FsGroupStrategyOptionsV1Beta1 fsGroup;
        private imports.k8s.RunAsUserStrategyOptionsV1Beta1 runAsUser;
        private imports.k8s.SeLinuxStrategyOptionsV1Beta1 seLinux;
        private imports.k8s.SupplementalGroupsStrategyOptionsV1Beta1 supplementalGroups;
        private java.util.List<java.lang.String> allowedCapabilities;
        private java.util.List<imports.k8s.AllowedCsiDriverV1Beta1> allowedCsiDrivers;
        private java.util.List<imports.k8s.AllowedFlexVolumeV1Beta1> allowedFlexVolumes;
        private java.util.List<imports.k8s.AllowedHostPathV1Beta1> allowedHostPaths;
        ...
        private java.util.List<imports.k8s.HostPortRangeV1Beta1> hostPorts;
        ...
        private imports.k8s.RunAsGroupStrategyOptionsV1Beta1 runAsGroup;
        private imports.k8s.RuntimeClassStrategyOptionsV1Beta1 runtimeClass;
         ...
         * @return {@code this}
         */
        public Builder fsGroup(imports.k8s.FsGroupStrategyOptionsV1Beta1 fsGroup) {
         ...
         * @return {@code this}
         */
        public Builder runAsUser(imports.k8s.RunAsUserStrategyOptionsV1Beta1 runAsUser) {
         ...
         * @return {@code this}
         */
        public Builder seLinux(imports.k8s.SeLinuxStrategyOptionsV1Beta1 seLinux) {
         ...
         * @return {@code this}
         */
        public Builder supplementalGroups(imports.k8s.SupplementalGroupsStrategyOptionsV1Beta1 supplementalGroups) {
        ...
        public Builder allowedCsiDrivers(java.util.List<? extends imports.k8s.AllowedCsiDriverV1Beta1> allowedCsiDrivers) {
            this.allowedCsiDrivers = (java.util.List<imports.k8s.AllowedCsiDriverV1Beta1>)allowedCsiDrivers;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder allowedFlexVolumes(java.util.List<? extends imports.k8s.AllowedFlexVolumeV1Beta1> allowedFlexVolumes) {
            this.allowedFlexVolumes = (java.util.List<imports.k8s.AllowedFlexVolumeV1Beta1>)allowedFlexVolumes;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder allowedHostPaths(java.util.List<? extends imports.k8s.AllowedHostPathV1Beta1> allowedHostPaths) {
            this.allowedHostPaths = (java.util.List<imports.k8s.AllowedHostPathV1Beta1>)allowedHostPaths;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder hostPorts(java.util.List<? extends imports.k8s.HostPortRangeV1Beta1> hostPorts) {
            this.hostPorts = (java.util.List<imports.k8s.HostPortRangeV1Beta1>)hostPorts;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder runAsGroup(imports.k8s.RunAsGroupStrategyOptionsV1Beta1 runAsGroup) {
         ...
         * @return {@code this}
         */
        public Builder runtimeClass(imports.k8s.RuntimeClassStrategyOptionsV1Beta1 runtimeClass) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityPolicySpecV1Beta1 {
        private final imports.k8s.FsGroupStrategyOptionsV1Beta1 fsGroup;
        private final imports.k8s.RunAsUserStrategyOptionsV1Beta1 runAsUser;
        private final imports.k8s.SeLinuxStrategyOptionsV1Beta1 seLinux;
        private final imports.k8s.SupplementalGroupsStrategyOptionsV1Beta1 supplementalGroups;
        private final java.util.List<java.lang.String> allowedCapabilities;
        private final java.util.List<imports.k8s.AllowedCsiDriverV1Beta1> allowedCsiDrivers;
        private final java.util.List<imports.k8s.AllowedFlexVolumeV1Beta1> allowedFlexVolumes;
        private final java.util.List<imports.k8s.AllowedHostPathV1Beta1> allowedHostPaths;
        ...
        private final java.util.List<imports.k8s.HostPortRangeV1Beta1> hostPorts;
        ...
        private final imports.k8s.RunAsGroupStrategyOptionsV1Beta1 runAsGroup;
        private final imports.k8s.RuntimeClassStrategyOptionsV1Beta1 runtimeClass;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.fsGroup = software.amazon.jsii.Kernel.get(this, "fsGroup", software.amazon.jsii.NativeType.forClass(imports.k8s.FsGroupStrategyOptionsV1Beta1.class));
            this.runAsUser = software.amazon.jsii.Kernel.get(this, "runAsUser", software.amazon.jsii.NativeType.forClass(imports.k8s.RunAsUserStrategyOptionsV1Beta1.class));
            this.seLinux = software.amazon.jsii.Kernel.get(this, "seLinux", software.amazon.jsii.NativeType.forClass(imports.k8s.SeLinuxStrategyOptionsV1Beta1.class));
            this.supplementalGroups = software.amazon.jsii.Kernel.get(this, "supplementalGroups", software.amazon.jsii.NativeType.forClass(imports.k8s.SupplementalGroupsStrategyOptionsV1Beta1.class));
            ...
            this.allowedCsiDrivers = software.amazon.jsii.Kernel.get(this, "allowedCsiDrivers", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AllowedCsiDriverV1Beta1.class)));
            this.allowedFlexVolumes = software.amazon.jsii.Kernel.get(this, "allowedFlexVolumes", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AllowedFlexVolumeV1Beta1.class)));
            this.allowedHostPaths = software.amazon.jsii.Kernel.get(this, "allowedHostPaths", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AllowedHostPathV1Beta1.class)));
            ...
            this.hostPorts = software.amazon.jsii.Kernel.get(this, "hostPorts", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.HostPortRangeV1Beta1.class)));
            ...
            this.runAsGroup = software.amazon.jsii.Kernel.get(this, "runAsGroup", software.amazon.jsii.NativeType.forClass(imports.k8s.RunAsGroupStrategyOptionsV1Beta1.class));
            this.runtimeClass = software.amazon.jsii.Kernel.get(this, "runtimeClass", software.amazon.jsii.NativeType.forClass(imports.k8s.RuntimeClassStrategyOptionsV1Beta1.class));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.FsGroupStrategyOptionsV1Beta1 fsGroup, final imports.k8s.RunAsUserStrategyOptionsV1Beta1 runAsUser, final imports.k8s.SeLinuxStrategyOptionsV1Beta1 seLinux, final imports.k8s.SupplementalGroupsStrategyOptionsV1Beta1 supplementalGroups, final java.util.List<java.lang.String> allowedCapabilities, final java.util.List<? extends imports.k8s.AllowedCsiDriverV1Beta1> allowedCsiDrivers, final java.util.List<? extends imports.k8s.AllowedFlexVolumeV1Beta1> allowedFlexVolumes, final java.util.List<? extends imports.k8s.AllowedHostPathV1Beta1> allowedHostPaths, final java.util.List<java.lang.String> allowedProcMountTypes, final java.util.List<java.lang.String> allowedUnsafeSysctls, final java.lang.Boolean allowPrivilegeEscalation, final java.util.List<java.lang.String> defaultAddCapabilities, final java.lang.Boolean defaultAllowPrivilegeEscalation, final java.util.List<java.lang.String> forbiddenSysctls, final java.lang.Boolean hostIpc, final java.lang.Boolean hostNetwork, final java.lang.Boolean hostPid, final java.util.List<? extends imports.k8s.HostPortRangeV1Beta1> hostPorts, final java.lang.Boolean privileged, final java.lang.Boolean readOnlyRootFilesystem, final java.util.List<java.lang.String> requiredDropCapabilities, final imports.k8s.RunAsGroupStrategyOptionsV1Beta1 runAsGroup, final imports.k8s.RuntimeClassStrategyOptionsV1Beta1 runtimeClass, final java.util.List<java.lang.String> volumes) {
        ...
        @Override
        public final imports.k8s.FsGroupStrategyOptionsV1Beta1 getFsGroup() {
            return this.fsGroup;
        }

        @Override
        public final imports.k8s.RunAsUserStrategyOptionsV1Beta1 getRunAsUser() {
            return this.runAsUser;
        }

        @Override
        public final imports.k8s.SeLinuxStrategyOptionsV1Beta1 getSeLinux() {
            return this.seLinux;
        }

        @Override
        public final imports.k8s.SupplementalGroupsStrategyOptionsV1Beta1 getSupplementalGroups() {
        ...
        @Override
        public final java.util.List<imports.k8s.AllowedCsiDriverV1Beta1> getAllowedCsiDrivers() {
            return this.allowedCsiDrivers;
        }

        @Override
        public final java.util.List<imports.k8s.AllowedFlexVolumeV1Beta1> getAllowedFlexVolumes() {
            return this.allowedFlexVolumes;
        }

        @Override
        public final java.util.List<imports.k8s.AllowedHostPathV1Beta1> getAllowedHostPaths() {
        ...
        @Override
        public final java.util.List<imports.k8s.HostPortRangeV1Beta1> getHostPorts() {
        ...
        @Override
        public final imports.k8s.RunAsGroupStrategyOptionsV1Beta1 getRunAsGroup() {
            return this.runAsGroup;
        }

        @Override
        public final imports.k8s.RuntimeClassStrategyOptionsV1Beta1 getRuntimeClass() {
        ...
        public final boolean equals(final Object o) {
            ...
            PodSecurityPolicySpecV1Beta1.Jsii$Proxy that = (PodSecurityPolicySpecV1Beta1.Jsii$Proxy) o;
