...
public interface ReplicationControllerSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpec {
         ...
         */
        protected Jsii$Proxy(final java.lang.Number minReadySeconds, final java.lang.Number replicas, final java.util.Map<java.lang.String, java.lang.String> selector, final imports.k8s.PodTemplateSpec template) {
