...
public interface KubeRoleListProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubeRoleListProps> {
        private java.util.List<imports.k8s.KubeRoleProps> items;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeRoleListProps {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.KubeRoleProps> items, final imports.k8s.ListMeta metadata) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.items = (java.util.List<imports.k8s.KubeRoleProps>)java.util.Objects.requireNonNull(items, "items is required");
            this.metadata = metadata;
        }
