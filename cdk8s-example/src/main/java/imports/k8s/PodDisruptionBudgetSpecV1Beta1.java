 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.563Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.PodDisruptionBudgetSpecV1Beta1")
@software.amazon.jsii.Jsii.Proxy(PodDisruptionBudgetSpecV1Beta1.Jsii$Proxy.class)
public interface PodDisruptionBudgetSpecV1Beta1 extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodDisruptionBudgetSpecV1Beta1}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodDisruptionBudgetSpecV1Beta1}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodDisruptionBudgetSpecV1Beta1> {
        private imports.k8s.IntOrString maxUnavailable;
        private imports.k8s.IntOrString minAvailable;
        private imports.k8s.LabelSelector selector;

        /**
         * Sets the value of {@link PodDisruptionBudgetSpecV1Beta1#getMaxUnavailable}
        ...
        /**
         * Sets the value of {@link PodDisruptionBudgetSpecV1Beta1#getMinAvailable}
        ...
        /**
         * Sets the value of {@link PodDisruptionBudgetSpecV1Beta1#getSelector}
         ...
         * @return a new instance of {@link PodDisruptionBudgetSpecV1Beta1}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodDisruptionBudgetSpecV1Beta1 build() {
            return new Jsii$Proxy(maxUnavailable, minAvailable, selector);
        }
    }

    /**
     * An implementation for {@link PodDisruptionBudgetSpecV1Beta1}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodDisruptionBudgetSpecV1Beta1 {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.IntOrString maxUnavailable, final imports.k8s.IntOrString minAvailable, final imports.k8s.LabelSelector selector) {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("k8s.PodDisruptionBudgetSpecV1Beta1"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodDisruptionBudgetSpecV1Beta1.Jsii$Proxy that = (PodDisruptionBudgetSpecV1Beta1.Jsii$Proxy) o;
