 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.552Z")
...
public interface NetworkPolicyIngressRule extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<NetworkPolicyIngressRule> {
        private java.util.List<imports.k8s.NetworkPolicyPeer> from;
        private java.util.List<imports.k8s.NetworkPolicyPort> ports;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicyIngressRule {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.NetworkPolicyPeer> from, final java.util.List<? extends imports.k8s.NetworkPolicyPort> ports) {
