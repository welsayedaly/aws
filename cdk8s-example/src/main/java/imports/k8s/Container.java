 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.394Z")
...
public interface Container extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<Container> {
        ...
        private imports.k8s.Lifecycle lifecycle;
        private imports.k8s.Probe livenessProbe;
        private java.util.List<imports.k8s.ContainerPort> ports;
        private imports.k8s.Probe readinessProbe;
        private imports.k8s.ResourceRequirements resources;
        private imports.k8s.SecurityContext securityContext;
        private imports.k8s.Probe startupProbe;
        ...
        private java.util.List<imports.k8s.VolumeDevice> volumeDevices;
        ...
        public Container build() {
            return new Jsii$Proxy(name, args, command, env, envFrom, image, imagePullPolicy, lifecycle, livenessProbe, ports, readinessProbe, resources, securityContext, startupProbe, stdin, stdinOnce, terminationMessagePath, terminationMessagePolicy, tty, volumeDevices, volumeMounts, workingDir);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements Container {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String name, final java.util.List<java.lang.String> args, final java.util.List<java.lang.String> command, final java.util.List<? extends imports.k8s.EnvVar> env, final java.util.List<? extends imports.k8s.EnvFromSource> envFrom, final java.lang.String image, final java.lang.String imagePullPolicy, final imports.k8s.Lifecycle lifecycle, final imports.k8s.Probe livenessProbe, final java.util.List<? extends imports.k8s.ContainerPort> ports, final imports.k8s.Probe readinessProbe, final imports.k8s.ResourceRequirements resources, final imports.k8s.SecurityContext securityContext, final imports.k8s.Probe startupProbe, final java.lang.Boolean stdin, final java.lang.Boolean stdinOnce, final java.lang.String terminationMessagePath, final java.lang.String terminationMessagePolicy, final java.lang.Boolean tty, final java.util.List<? extends imports.k8s.VolumeDevice> volumeDevices, final java.util.List<? extends imports.k8s.VolumeMount> volumeMounts, final java.lang.String workingDir) {
