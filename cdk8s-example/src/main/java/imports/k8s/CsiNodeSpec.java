...
public interface CsiNodeSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CsiNodeSpec> {
        private java.util.List<imports.k8s.CsiNodeDriver> drivers;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CsiNodeSpec {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.CsiNodeDriver> drivers) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.drivers = (java.util.List<imports.k8s.CsiNodeDriver>)java.util.Objects.requireNonNull(drivers, "drivers is required");
        }
