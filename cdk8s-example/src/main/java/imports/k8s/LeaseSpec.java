...
public interface LeaseSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LeaseSpec {
         ...
         */
        protected Jsii$Proxy(final java.time.Instant acquireTime, final java.lang.String holderIdentity, final java.lang.Number leaseDurationSeconds, final java.lang.Number leaseTransitions, final java.time.Instant renewTime) {
