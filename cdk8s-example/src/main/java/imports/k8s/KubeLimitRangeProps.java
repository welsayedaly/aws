 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.504Z")
...
public interface KubeLimitRangeProps extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeLimitRangeProps {
         ...
         */
        protected Jsii$Proxy(final imports.k8s.ObjectMeta metadata, final imports.k8s.LimitRangeSpec spec) {
