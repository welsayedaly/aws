 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.39.0 (build 8af72c2)", date = "2021-10-15T13:35:33.531Z")
...
public interface KubeSecretProps extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<KubeSecretProps> {
        ...
        public KubeSecretProps build() {
            return new Jsii$Proxy(data, immutable, metadata, stringData, type);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements KubeSecretProps {
         ...
         */
        protected Jsii$Proxy(final java.util.Map<java.lang.String, java.lang.String> data, final java.lang.Boolean immutable, final imports.k8s.ObjectMeta metadata, final java.util.Map<java.lang.String, java.lang.String> stringData, final java.lang.String type) {
